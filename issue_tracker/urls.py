...
from .views import render_contact_us_page, display_community_page, bug_form_page, view_bug_details, render_all_bugs, edit_issue, delete_issue, like_a_bug_post
...
urlpatterns = [
    ...
    url(r'^like$', like_a_bug_post, name='like'),
